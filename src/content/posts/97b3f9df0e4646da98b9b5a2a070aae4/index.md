...
description: '**:checked** CSS 伪类选择器表示任何处于选中状态的radio(<input type="radio">), checkbox (<input type="checkbox">) 或 ("select") 元素中的option HTML 元素 ("option")。'
image: 'https://picsum.photos/seed/97b3f9df0e4646da98b9b5a2a070aae4/1920/1080'
tags: ["css","伪类"]
category: '技术'
draft: false
---
...
![adb349855c0a1c4b1a0d40d62492ee07.png](./7a8bfa42314d4e2199b13a947d37e2f1.png)
...
![9a81c3847e3dc260ac190b38c0cc8170.png](./b99139ebff3a429381cb81e0c5c1491c.png)