...
description: '因为powerline以及homebrew均需要安装command line tool，网络条件优越的同学在执行本文下面内容之前，可以先安装XCode并打开运行一次（会初始化安装components），省去以后在iterm2中的等待时间。'
image: 'https://picsum.photos/seed/559ace6333814f19976dda7217d0c298/1920/1080'
tags: ["iterm2"]
category: '技术'
draft: false
---
