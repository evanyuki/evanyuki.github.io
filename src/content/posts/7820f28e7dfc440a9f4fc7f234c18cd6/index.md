...
description: '*   Ubuntu版本：Ubuntu 20.04'
image: 'https://picsum.photos/seed/7820f28e7dfc440a9f4fc7f234c18cd6/1920/1080'
tags: ["wordpress"]
category: '技术'
draft: false
---
...
![1be664e50663d50f8cca7e4216db17e0.png](./4e4843221b4848fc88aa96654f62a18a.png)
...
访问后台-工具-导入
![993840d0c5f82a0e908fb4ac710eb0e9.png](./c0476046c9774088995854f79deeb2da.png)

上传data文件并导入：点击"运行导入器"，进入 WordPress 导入界面 ——》选择导出的xml文件 ——》上传文件并导入
![87a131c6604cc11e722fea7827aef882.png](./ac1597db512643b38067dc510cc023c2.png)

#### 导出数据

访问后台 —工具 —导出—选择“所有内容”，下载导出的文件。你将得到一个 .XML 文件，这个XML文件包含全部文章、页面、评论、自定义栏目、分类目录和标签。
![e6bb3eb026d7febf05bcbe9de93db486.png](./da1dbbdcbc334bcb9aed8060b8ea2844.png)
