...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/53643448.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
		position: "center", // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
		credit: {
			enable: true, // Display the credit text of the banner image
			text: "WLOP | 北漠", // Credit text to be displayed
			url: "https://www.pixiv.net/artworks/53643448", // (Optional) URL link to the original artwork or artist's page
		},
	},
	toc: {
	...
	links: [
		{
			...
			url: "https://x.com/Linerzore",
		},
		{
			name: "Instagram",
			icon: "fa6-brands:instagram",
			url: "https://www.instagram.com/kilienazure",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/evanyuki",
		},
	],
};
